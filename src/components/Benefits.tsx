...
const Benefits = () => {
  const benefits = ["Improved sleep quality and patterns", "Enhanced immune system function", "Better stress response and emotional balance", "Reduced tension and physical discomfort", "Improved focus and mental clarity", "Enhanced digestive function", "Better posture and body awareness", "Support for natural healing processes"];
  return <section className="py-20 bg-card">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12 animate-fade-in">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">Benefits of Talsky Tonal 
Chiropractic Care</h2>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {benefits.map((benefit, index) => <div key={index} className="flex items-start gap-3 animate-slide-in-left" style={{
